...
const TTS_URL = 'http://127.0.0.1:5011';
...
function claimProject(project) {
    ...
    const req = http.request({ hostname: '127.0.0.1', port: 5011, path: '/claim-project', method: 'POST',
...
class TTSTap {
    constructor(project) {
        ...
        this.echoPending = '';
        this.muted = true; // All TTS is browser-based now — server-side TTS disabled by default
    }
